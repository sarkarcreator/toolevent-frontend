...
const publicRoutes = [
  ...
  '/ai-planner',
  '/templates',
  '/templates/ultimate-event-budget-planner',
  '/templates/wedding-budget-planner',
  '/templates/corporate-event-planner',
  '/templates/conference-planner',
  '/templates/event-profit-planner',
  '/templates/event-roi-planner',
  '/templates/event-planning-checklist',
  '/templates/complete-event-planning-bundle',
  '/resources',
  '/methodology',
  '/blog',
  '/about',
